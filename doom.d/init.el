...
(doom! :input
       ...
       :emacs
       (dired +ranger +icons dired-rsync diff-hl)             ; making dired pretty [functional]
       ...
       (org
        ...
        +gnuplot
        +hugo
        ;; +ipython      ;; Deprecated, use jupyter
        +journal
        +jupyter
        +noter
        +pandoc
       ...
       ;; scala             ; java, but good ;; Package not available: ob-ammonit
       (scheme
        +chicken
        +guile
        +racket)
